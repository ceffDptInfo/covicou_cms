...
tinymce.init({
    ...
    cmsms_tiny: cmsms_tiny = {
        schema: 'html5',
        base_url : 'https://covicou.ch/',
        resize : true,
        statusbar : true,
        menubar : true,
        filepicker_title : 'Fichiers CMSMS',
        filepicker_url : 'https://covicou.ch/admin/moduleinterface.php?mact=MicroTiny,m1_,filepicker,0&_sk_=6e64a970827d357e&showtemplate=false&field=',
        ...
        linker_image : 'https://covicou.ch/modules/MicroTiny/lib/images/cmsmslink.gif',
        linker_url : 'https://covicou.ch/admin/moduleinterface.php?mact=MicroTiny,m1_,linker,0&_sk_=6e64a970827d357e&showtemplate=false',
        linker_autocomplete_url : 'https://covicou.ch/admin/moduleinterface.php?mact=MicroTiny,m1_,ajax_getpages,0&_sk_=6e64a970827d357e&showtemplate=false',
